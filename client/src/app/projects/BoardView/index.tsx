...
const BoardView = ({ id, setIsModalNewTaskOpen }: BoardProps) => {
  ...
  if (error) {
    return <div>An error occurred while fetchng tasks</div>;
  }
  return (
  ...
  return (
    ...
    >
      {task.attachments && task.attachments.length > 0 && (
        <Image
          src={`https://hui-pm-image-s3.s3.us-west-2.amazonaws.com/${task.attachments[0].fileURL}`}
          ...
          <div className="flex -space-x-[6px] overflow-hidden">
                {task.assignee && (
                    <Image
                      ...
                      src={`https://hui-pm-image-s3.s3.us-west-2.amazonaws.com/${task.assignee.profilePictureUrl}`}
                ...
                {task.author && (
                    <Image
                      ...
                      src={`https://hui-pm-image-s3.s3.us-west-2.amazonaws.com/${task.author.profilePictureUrl}`}
